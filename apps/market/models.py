...
class Product(models.Model):
    ...
    site_price = models.DecimalField(help_text="preço/unit", max_digits=9, decimal_places=4, validators=[MinValueValidator(Decimal('0.01'))], blank=True, null=True)
    price = models.DecimalField(help_text="preço/kg", max_digits=9, decimal_places=4, blank=True, validators=[MinValueValidator(Decimal('0.01'))])
    price_real = models.DecimalField( help_text="preço/kg", max_digits=9, decimal_places=4, blank=True, default=1.00, validators=[MinValueValidator(Decimal('0.01'))])
    old_price = models.DecimalField(help_text="preço/kg", max_digits=9, decimal_places=4, blank=True, default=0.00, validators=[MinValueValidator(Decimal('0.01'))])
    is_active = models.BooleanField(default=False)
